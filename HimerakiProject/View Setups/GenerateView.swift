...
extension generateViewController{
    ...
    func applyConstraints(){
        ...
        confirmButton.anchor(top: nil, leading: view.safeAreaLayoutGuide.leadingAnchor, bottom: view.safeAreaLayoutGuide.bottomAnchor, trailing: view.safeAreaLayoutGuide.trailingAnchor, padding: UIEdgeInsets(top: 0, left: 20, bottom: 10, right: 20), size: CGSize(width: 0, height: 54))
    }
}
