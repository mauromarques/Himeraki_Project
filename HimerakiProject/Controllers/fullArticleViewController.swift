...
var urlForWebView = URL(string: "www.google.com")
...
class fullArticleViewController: StatusBarAnimatableViewController, UITextViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        photoCreditsLabel = createCreditsLabel()
        categoryLabel = createCategoryLabel()
        titleLabel = createTitleLabel()
        publisherLabel = createPublisherLabel()
        ...
        bottomContainer.addSubview(photoCreditsLabel)
        bottomContainer.addSubview(titleLabel)
        bottomContainer.addSubview(publisherLabel)
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        photoCreditsLabel.text = "Photo by \(new.photoCredits ?? "Photographer")"
        publisherLabel.text = "Published by: \(new.publisher ?? "Publisher")"
    ...
    @objc func handleDismissalPan(gesture: UIPanGestureRecognizer) {
        ...
        UIView.animate(withDuration: 0.3) {
            targetAnimatedView.layer.cornerRadius = 15
        ...
        case .ended, .cancelled:
            ...
            UIView.animate(withDuration: 0.3) {
                targetAnimatedView.layer.cornerRadius = 0
            }
